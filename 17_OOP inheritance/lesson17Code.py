...
class BlueBlob(Blob):
    def __init__(self, color, x_boundry, y_boundry):
        super().__init__(color, x_boundry, y_boundry)
        self.color = BLUE
...
def draw_environment(blob_list):
    ...
    for blob_dict in blob_list:
        for blob_id in blob_dict:
            ...
            elif blob.x > blob.x_boundry: blob.x = blob.x_boundry

            if blob.y < 0: blob.y = 0
            elif blob.y > blob.y_boundry: blob.y = blob.y_boundry
